...
public class EmployeeWageComputation {
    ...
    public static void main(String[] args) {
        ...
        EmployeeWageComputation bridgeLabz = new EmployeeWageComputation("BridgeLabz", 25, 15, 100);
        bridgeLabz.totalEmpWage(bridgeLabz.company, bridgeLabz.empRatePerHour, bridgeLabz.numOfWorkingDays, bridgeLabz.maxHoursPerMonth);
